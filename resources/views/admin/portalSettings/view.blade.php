  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 style="text-align: center;">Administrator Profile</h1>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body box-profile">
                ...
                <a href="{{ url('admin/adminProfile/edit/') }}" class="text-center">
                  <button class="btn btn-warning m-2">Edit Profile</button>
                </a>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Customer ID: </b> <a class="float-right">{{$customer_data->id}}</a>
                  </li>
                  <li class="list-group-item">
