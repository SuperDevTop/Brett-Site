      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6 d-flex justify-content-end">
              <a href="{{ route('admin_business_add') }}"><button class="btn btn-info align-right">Add New Business User</button></a>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="card-header">
                <h3 class="card-title">Business User Records</h3>
              </div>
                  ...
                  @if( isset($customer_all) && count($customer_all) > 0 )
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="{{ url('admin/business/view/'.$customer->id) }}">
                            <button class="btn btn-default" title="View"><i class="far fa-eye"></i></button>
                          </a>

                          <a href="{{ url('admin/business/edit/'.$customer->id) }}">
                            <button class="btn btn-warning">
                              <i class="fas fa-edit" title="Edit Record"></i>
                            </button>
                          </a>

                          <a href="{{ url('admin/business/delete/'.$customer->id) }}" onclick="return confirm('Are you sure to Delete?');">
