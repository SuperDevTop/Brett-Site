        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('admin/EditCategoriesProcess/'.$customer_data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                      <div class="col-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="c_name" name="c_name" placeholder="Enter First Name"   autocomplete="off" value="{{old('c_name', $customer_data->name)}}" required>
                          @error('c_name')
