      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6 d-flex justify-content-end">
              <a href="{{ route('admin_categories_add') }}"><button class="btn btn-info align-right">Add New Category</button></a>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="card-header">
                <h3 class="card-title">Category Records</h3>
              </div>
                      ...
                      <tr>
                        ...
                        <td>
                          @if($customer->cat_image && $customer->cat_image != '')
                            <img src="{{asset('assets/img/categories/').'/'.$customer->cat_image}}" class="img_custom" />
                            @else
                        ...
                        <td>
                          ...
                          <a href="{{ url('admin/categories/edit/'.$customer->id) }}">
                            <button class="btn btn-warning">
                              <i class="fas fa-edit" title="Edit Record"></i>
                            </button>
                          </a>

                          <a href="{{ url('admin/categories/delete/'.$customer->id) }}" onclick="return confirm('Are you sure to Delete?');">
