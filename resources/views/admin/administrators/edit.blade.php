          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Admin/Employee</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ url('admin/Editadmin_employeeProcess/'.$customer_data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                  ...
                  <a href="{{ route('admin_employee_listing') }}"><button type="button" class="btn btn-warning">Back</button></a>
