...
<body>
  <div class="container" style="overflow: hidden; margin-bottom: 200px;">
    ...
    <div class="container">
      <h2 style="text-align: left; margin-top: 20px;">My Deals</h2>
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12">
        <form  action="{{ url('AddDealsProcess') }}" method="post" enctype="multipart/form-data" class="profile-form">
          <h1 style="text-align: center;font-weight: 200; color: #999999; margin-top: 20px;">Add Deals</h1>
          @csrf
          <div class="profile" >
            ...
            <div class="row">
              ...
              <div class="col-lg-12 col-md-3 col-sm-4 mb-1">
                ...
                <input type="date" class="form-control w-100" id="start_date_time" name="start_date_time" value="" placeholder="Start Date Time" required>
              </div>

              <div class="col-lg-12 col-md-3 col-sm-4 mb-1">
                <label>Deal End Date</label>
                <input type="date" class="form-control w-100" id="end_date_time" name="end_date_time" value="" placeholder="End Date Time" required>
              </div>

              <span style="display: none;">
                <h1 style="text-align: center;font-weight: bold;color: #306F29; width: 100%;"> Deal SEO Meta </h1>
                <div class="col-md-6">
                  <input type="text" name="seo_title" placeholder="SEO Title" class="form-control w-100">
                  <input type="text" name="seo_keyword" placeholder="SEO Keyword" class="form-control w-100">
                ...
                <div class="col-md-6 label_input_verticle_center">
                  <textarea rows="4" name="seo_description" cols="50" class="form-control w-100" style="min-height: 134px;" spellcheck="true" placeholder="SEO Description"></textarea>
                </div>
              </span>
            ...
            <div class="row">                  
                ...
                <button class="btn btn-success w-100" style="padding: 6px !important;"> Add Deal </button>
        ...
        <div class="col-lg-8 col-md-12 col-sm-12">
          <div><h1 style="text-align: center;font-weight: 200; color: #999999; margin-top: 20px;">All Deals</h1></div>
                ...
                <tr>
                  <td style="font-weight: normal !important;" colspan="100">
                    <div class="p-5 text-center" style="display: block; margin:0 auto ">
                      ...
                      <p class="text-center"> You can add new Deals from the Form.</p>
                    </div>
                  </td>
                </tr>
                <?php
